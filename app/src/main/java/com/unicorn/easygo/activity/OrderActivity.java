...
//    }
    ...
    public void setData(){
        ...
        myOrderListItem data = new myOrderListItem("Geer vr 头戴眼镜\n购入时间：2017-06-29 15:32\n总价：¥2457", R.drawable.glasses);
        type.addItem(data);
        list.add(type);

        Type type1 = new Type("一周" );
        myOrderListItem data1 = new myOrderListItem("乐视薯片、沐浴露等11件商品\n购入时间：2017-06-25 18:33\n总价：￥230", R.drawable.shupian);
        myOrderListItem data2 = new myOrderListItem("瓦利亚太阳镜、乐事薯片等3件商品\n购入时间：2017-06-23 13:23\n总价：￥438",R.drawable.taiyangjing);
        type1.addItem(data1);
        type1.addItem(data2);
        list.add(type1);

        Type type2 = new Type("一个月" );
        myOrderListItem data3 = new myOrderListItem("六神花露水、丝塔芙洁面乳等6件商品\n购入时间:2017-05-20 19:30\n总价：￥328.3", R.drawable.sixgod);
        myOrderListItem data4 = new myOrderListItem("蒙牛酸酸乳、真果粒等3件商品\n购入时间:2017-05-15 10:32\n总价：￥56.2",R.drawable.mengniu);
        myOrderListItem data5 = new myOrderListItem("潘婷润发喷雾、得力笔记本等7件商品\n购入时间:2017-04-01 12:23\n总价：￥324",R.drawable.deli);
        type2.addItem(data3);
        type2.addItem(data4);
        type2.addItem(data5);
        list.add(type2);
